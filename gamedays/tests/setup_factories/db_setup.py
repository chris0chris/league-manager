...
class DBSetup:
    ...
    def g72_finished(self, season=None):
        ...
        self.create_finalround_game(
            gameday, standing="P5-1", status="beendet", home=b3, away=a3
        )
        self.create_finalround_game(
            gameday, standing="P5-2", status="beendet", home=a4, away=b3
        )
        return gameday
    ...
    def _create_gameday(
        ...
        teams_group_a = self.create_group(
            gameday=gameday,
            name="A",
            standing="Gruppe 1",
            status=qualify,
        ...
        teams_group_b = self.create_group(
            gameday=gameday,
            name="B",
            standing="Gruppe 2",
            status=qualify,
    ...
    def create_teams(self, name, number_teams):
        ...
        for i in range(number_teams):
            ...
            teams.append(
                TeamFactory(
                    name=(name + team_number), description=f"{name * 7}{team_number}"
                )
            )
        return teams
    ...
    def create_teamlog_home_and_away(
        self, home=None, away=None, gameinfo=None
    ) -> Gameinfo:
        if home is None:
        ...
        if gameinfo is None:
            ...
            GameresultFactory(
                gameinfo=gameinfo, team=home, fh=2, sh=1, pa=2, isHome=True
            )
    ...
    def create_broken_teamlog_home_and_away(
        self, home=None, away=None, gameinfo=None
    ) -> Gameinfo:
        if home is None:
            home = TeamFactory(name="Home")
    ...
    def create_teamlog_home(
        self, gameinfo, home, half_1: bool = True, half_2: bool = True
    ):
    ...
    def create_teamlog_away(
        self, gameinfo, away, half_1: bool = False, half_2: bool = True
    ):
        author = gameinfo.gameday.author
        if half_1:
            TeamLogFactory(
