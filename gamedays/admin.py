...
from gamedays.models import (
    Gameday, Gameinfo, Gameresult, GameOfficial, GameSetup, TeamLog, Person,
...
class GamedayManagerAdmin(admin.ModelAdmin):
    list_display = ['user', 'gameday', 'can_edit_details', 'can_assign_officials',
                    'can_manage_scores', 'assigned_at', 'assigned_by']
    list_filter = ['gameday__league', 'gameday__season', 'assigned_at',
    ...
    fieldsets = (
        ...
        ('Permissions', {
            'fields': ('can_edit_details', 'can_assign_officials', 'can_manage_scores'),
...
class TeamManagerAdmin(admin.ModelAdmin):
    list_display = ['user', 'team', 'can_edit_roster', 'can_submit_passcheck', 'assigned_at', 'assigned_by']
