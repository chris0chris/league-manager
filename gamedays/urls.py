...
from .views import GamedayDetailView, GamedayListView, GamedayCreateView, GamedayUpdateView, GamedayGameDetailView
...
urlpatterns = [
    ...
    path('gameday/<int:gameday_pk>/game/<int:pk>', GamedayGameDetailView.as_view(), name=LEAGUE_GAMEDAY_GAME_DETAIL),
