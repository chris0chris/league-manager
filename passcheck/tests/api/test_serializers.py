...
class TestRosterValidationSerializer(TestCase):
    def test_serializer_is_working_with_validator(self):
        prime_league, _, _, season, second_league_team = (
        ...
        second_league_team = [
            {
                "id": 7,
                "player__person__first_name": "Oscarius",
                "player__person__last_name": "Oldus",
                "jersey_number": 98,
                "player__pass_number": 9898989,
                "player__person__sex": 2,
                "player__person__year_of_birth": 1909,
                league_id: 55,
                "is_selected": True,
                "gameday_jersey": None,
                "left_on": None,
            ...
            },
            {
                "id": 8,
                "team_id": 23,
                "player__person__first_name": "Juli",
                "player__person__last_name": "Jemale",
                "jersey_number": 7,
                "gameday_jersey": 77,
                "player__pass_number": 7,
                "player__person__sex": 1,
        ...
        serializer = RosterValidationSerializer(
            instance=second_league_team,
            context={
                "validator": ev,
                "all_leagues": [{"gamedays__league": prime_gameday.league_id}],
            },
            many=True,
        ).data
    ...
    def test_serializer_sets_validationError_when_no_validator_is_set(self):
        team = [
            {
                "id": 12,
                "player__person__first_name": "Marius",
                "player__person__last_name": "MissingValidator",
                "jersey_number": 0,
        ...
        serializer = RosterValidationSerializer(
            instance=team,
            is_staff=True,
            context={"all_leagues": [{"gamedays__league": 1}]},
            many=True,
        ).data
        assert dict(serializer[0]) == {
            "id": 12,
