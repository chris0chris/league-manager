...
class PlayerlistCreateForm(forms.ModelForm):
    ...
    year_of_birth = forms.IntegerField(
        label="Geburtsjahr", min_value=1900, max_value=2100
    )
    ...
    class Meta:
        ...
        widgets = {"team": autocomplete.ModelSelect2(url="/dal/team")}
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance and self.instance.pk:
            ...
            self.fields["year_of_birth"].initial = (
                self.instance.player.person.year_of_birth
            )
    ...
    def save(self, commit=True):
        ...
        player = Player.objects.create(person=person, pass_number=pass_number)
...
class PlayerlistUpdateForm(PlayerlistCreateForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["pass_number"].help_text = (
            "Die Passnummer ist nicht bearbeitbar. "
...
class PlayerlistTransferForm(PlayerlistCreateForm):
    ...
    def __init__(self, *args, action_type=None, **kwargs):
        ...
        player_to_transfer: PlayerlistTransfer = PlayerlistTransfer.objects.filter(
            current_team=self.instance, status="pending"
        ).first()
