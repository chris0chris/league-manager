...
from passcheck.api.views import (
    PasscheckRosterAPIView,
    PasscheckGamesAPIView,
    PasscheckGamesStatusAPIView,
...
urlpatterns = [
    ...
    path(
        "approval/team/<int:team_id>",
        PasscheckApprovalUrlAPIView.as_view(),
        name=API_PASSCHECK_EQUIPMENT_APPROVAL_URL,
    ),
    path(
        "games/status",
        PasscheckGamesStatusAPIView.as_view(),
        name=API_PASSCHECK_GAMES_STATUS,
    ),
    path(
        "games/<int:gameday>",
        PasscheckGamesAPIView.as_view(),
        name=API_PASSCHECK_SERVICE,
    ),
    path(
        "roster/<int:pk>/gameday/<int:gameday>",
        PasscheckRosterAPIView.as_view(),
