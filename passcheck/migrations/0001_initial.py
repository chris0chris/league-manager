    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('additional_teams',
                 models.ManyToManyField(related_name='relationship_additional_teams', to='gamedays.team')),
                ('league', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gamedays.league')),
                ('team',
                 models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='relationship_team',
                                      to='gamedays.team')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='playerlist',
            name='team',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='gamedays.team'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_subs_in_other_leagues', models.IntegerField(blank=True, default=None, null=True)),
                ('minimum_player_strength', models.IntegerField()),
                ('maximum_player_strength', models.IntegerField(blank=True, default=None, null=True)),
