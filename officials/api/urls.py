...
urlpatterns = [
    path(
        "team/<int:pk>/list",
        OfficialsTeamListAPIView.as_view(),
        name=API_OFFICIALS_FOR_TEAM,
    ),
    path(
        "search/exclude/team/<int:pk>/list",
        OfficialsSearchName.as_view(),
        name=API_OFFICIALS_SEARCH_BY_NAME,
    ),
]
