...
class TestClearCacheView(TestCase):
    ...
    def test_clear_cache_clears_cache_and_redirects_to_referer(self):
        ...
        response = self.client.get(self.url, HTTP_REFERER='http://testserver/some-page/')
...
class TestAllTeamListView(TestCase):
    ...
    @patch('gamedays.service.team_repository_service.TeamRepositoryService.get_all_teams')
