...
7. **Verify Before Push:** The full test suite and quality checks (especially LINTING) must be executed and pass locally before pushing changes to any remote branch. **LINTING IS MANDATORY BEFORE PUSH.**
