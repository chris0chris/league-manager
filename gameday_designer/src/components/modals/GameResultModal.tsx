          ...
          <Row className="mb-4 align-items-center">
            <Col>
              <Form.Group controlId="halftimeHome">
                <Form.Label className="small">{t('ui:label.home')}: {homeTeamName} ({t('ui:label.halftime')})</Form.Label>
                <Form.Control
                  type="number"
                  min="0"
                  value={halftimeHome}
            ...
            <Col>
              <Form.Group controlId="halftimeAway">
                <Form.Label className="small">{t('ui:label.away')}: {awayTeamName} ({t('ui:label.halftime')})</Form.Label>
                <Form.Control
                  type="number"
                  min="0"
                  value={halftimeAway}
          ...
          <Row className="mb-3 align-items-center">
            <Col>
              <Form.Group controlId="finalHome">
                <Form.Label className="small">{t('ui:label.home')}: {homeTeamName} ({t('ui:label.final')})</Form.Label>
                <Form.Control
                  type="number"
                  min="0"
                  value={finalHome}
            ...
            <Col>
              <Form.Group controlId="finalAway">
                <Form.Label className="small">{t('ui:label.away')}: {awayTeamName} ({t('ui:label.final')})</Form.Label>
                <Form.Control
                  type="number"
                  min="0"
                  value={finalAway}
