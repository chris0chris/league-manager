...
const AppHeader: React.FC = () => {
  ...
  return (
    <div className="bg-dark text-light py-2 px-3 mb-2 shadow-sm d-flex align-items-center justify-content-between">
      <div 
        onClick={() => navigate('/')} 
      ...
      <div className="d-flex align-items-center gap-3">
        {isEditor && (
          <Button 
            ...
            size="sm" 
            onClick={() => navigate('/')}
            className="d-flex align-items-center py-0 px-2"
        ...
        <div className="d-flex align-items-center text-light border-start ps-3" style={{ height: '20px' }}>
