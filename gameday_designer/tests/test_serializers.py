...
from gameday_designer.models import (
    ScheduleTemplate, TemplateSlot, TemplateUpdateRule,
    TemplateUpdateRuleTeam, TemplateApplication
)
...
class TestTemplateSlotSerializer:
    ...
    def test_serialize_slot_with_group_team_placeholders(self, template_slot, api_factory):
...
class TestTemplateUpdateRuleTeamSerializer:
    ...
    def test_serialize_team_rule(self, template, template_slot, api_factory):
        ...
        request = api_factory.get('/')
        serializer = TemplateUpdateRuleTeamSerializer(team_rule, context={'request': request})
        data = serializer.data
...
class TestTemplateUpdateRuleSerializer:
    ...
    def test_serialize_update_rule_with_nested_team_rules(self, template, template_slot, api_factory):
        ...
        request = api_factory.get('/')
        serializer = TemplateUpdateRuleSerializer(update_rule, context={'request': request})
        data = serializer.data
...
class TestScheduleTemplateListSerializer:
    ...
    def test_serialize_template_list_view(self, template, api_factory):
        ...
        request = api_factory.get('/')
        serializer = ScheduleTemplateListSerializer(template, context={'request': request})
        data = serializer.data
    ...
    def test_serialize_global_template(self, global_template, api_factory):
        ...
        request = api_factory.get('/')
        serializer = ScheduleTemplateListSerializer(global_template, context={'request': request})
        data = serializer.data
...
class TestScheduleTemplateDetailSerializer:
    ...
    def test_serialize_template_detail_with_slots(self, template, template_slot, api_factory):
        ...
        request = api_factory.get('/')
        serializer = ScheduleTemplateDetailSerializer(template, context={'request': request})
        data = serializer.data
    ...
    def test_serialize_template_with_update_rules(self, template, template_slot, api_factory):
    ...
    def test_create_template_auto_populates_created_by(self, association, api_factory, regular_user):
        ...
        serializer = ScheduleTemplateDetailSerializer(data=data, context={'request': request})
        assert serializer.is_valid(), serializer.errors
    ...
    def test_update_template_auto_populates_updated_by(self, template, api_factory, regular_user):
...
class TestApplyTemplateRequestSerializer:
    ...
    def test_validate_apply_request(self, template, gameday, api_factory):
        ...
        request = api_factory.post('/')
        serializer = ApplyTemplateRequestSerializer(data=data, context={'request': request})
...
class TestTemplateApplicationSerializer:
    ...
    def test_serialize_template_application(self, template, gameday, regular_user, api_factory):
        ...
        request = api_factory.get('/')
        serializer = TemplateApplicationSerializer(application, context={'request': request})
        data = serializer.data
...
class TestSerializerValidation:
    ...
    def test_slot_validation_mutually_exclusive_placeholders(self, template, api_factory):
    ...
    def test_template_validation_positive_num_teams(self, association, api_factory, staff_user):
