...
class TestTemplateListEndpoint:
    ...
    def test_list_returns_lightweight_serializer(self, api_client, template_with_slots):
        ...
        assert response.status_code == status.HTTP_200_OK
        template_data = next(
            (t for t in response.data if t['id'] == template_with_slots.pk),
            None
        )
    ...
    def test_staff_sees_all_templates(self, api_client, staff_user, template, global_template):
...
class TestTemplateDetailEndpoint:
    ...
    def test_detail_includes_nested_update_rules(
        self,
        api_client,
        template,
        db
...
class TestTemplateUpdateEndpoint:
    ...
    def test_anonymous_cannot_update_template(self, api_client, template):
        ...
        response = api_client.put(
            f'/api/designer/templates/{template.pk}/',
            data,
            format='json'
        )
    ...
    def test_association_user_cannot_update_global_template(
        ...
        response = api_client.put(
            f'/api/designer/templates/{global_template.pk}/',
            data,
            format='json'
        )
...
class TestTemplateCloneEndpoint:
    ...
    def test_staff_can_clone_template(self, api_client, staff_user, template_with_slots):
        ...
        response = api_client.post(
            f'/api/designer/templates/{template_with_slots.pk}/clone/',
            format='json'
        )
