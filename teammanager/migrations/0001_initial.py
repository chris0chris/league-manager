    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gameday', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='teammanager.gameday')),
            ],
        ),
        migrations.CreateModel(
            name='Permissions',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(blank=True, null=True, upload_to='teammanager/logos', verbose_name='Logo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('avatar', models.ImageField(blank=True, null=True, upload_to='media/teammanager/avatars',
                                             verbose_name='Avatar')),
                ...
                ('team',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='teammanager.team')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('permission',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='teammanager.permissions')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='teammanager.userprofile')),
            ],
        ),
        migrations.CreateModel(
            name='TeamLog',
            fields=[
                ...
                ('gameinfo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='teammanager.gameinfo')),
                ('team',
                 models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, to='teammanager.team')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('achievement',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='teammanager.achievement')),
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='teammanager.gameinfo')),
                (
                'player', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='teammanager.userprofile')),
            ],
        ),
        migrations.CreateModel(
            name='GameSetup',
        ...
        migrations.AddField(
            model_name='gameinfo',
            name='officials',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, to='teammanager.team'),
        ),
    ]
